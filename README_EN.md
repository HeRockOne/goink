...
- 5-phase validation: prepare → outline → write → cmd-review → maintain
- Each phase has tools whitelist + required call list
- maintain phase has 15-item checklist (see `core-writing-kernel.md`)
...
GET  /api/search-cmd-memory        Semantic search
...
| Fullscreen Reader | Font/line spacing adjustment, page turning, chapter index, progress cmd-memory |
...
- **Offline cache**: idb-keyval + cmd-memory Map, instant read offline
...
| core-writing-kernel.md | 15-item maintain checklist |
