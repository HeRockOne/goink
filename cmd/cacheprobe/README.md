...
2026-08-16 实测（DeepSeek 价 0.02/1/2，真实 DB + 门禁配置驱动，技能注入去重修正后）：

| 场景 | 单章 | 短对话 | 批量 | 输入 hit | 输入 miss | 输出 out | 命中率 | 成本 ¥ | 每章 ¥ |
|------|-----|-------|------|---------|----------|---------|--------|--------|--------|
| 单章 1 轮 | 1 | 0 | 0 | 2229272 | 190329 | 14271 | 92.1% | 0.2635 | 0.2635 |
| 单章 3 轮 | 3 | 0 | 0 | 12905505 | 632566 | 35058 | 95.3% | 0.9608 | 0.3203 |
| 单章 5 轮 | 5 | 0 | 0 | 32268055 | 1082959 | 62429 | 96.8% | 1.8532 | 0.3706 |
| 单章 5 轮 + 短对话 3 | 5 | 3 | 0 | 37740247 | 1197049 | 68452 | 96.9% | 2.0888 | 0.4178 |
| 批量 5 章 | 0 | 0 | 5 | 5031133 | 298626 | 23636 | 94.4% | 0.4465 | 0.0893 |
| 批量 5 章 + 短对话 2 | 0 | 2 | 5 | 6360359 | 375014 | 28177 | 94.4% | 0.5586 | 0.1117 |
| 混合 3+2+3 | 3 | 2 | 3 | 27661398 | 992623 | 60331 | 96.5% | 1.6665 | 0.2778 |
| 混合 5+5+5 | 5 | 5 | 5 | 66805167 | 1606761 | 96778 | 97.7% | 3.1364 | 0.3136 |
| 批量 10 章 | 0 | 0 | 10 | 9853473 | 428471 | 41074 | 95.8% | 0.7077 | 0.0708 |
| 批量 20 章 | 0 | 0 | 20 | 23416521 | 671106 | 65157 | 97.2% | 1.2698 | 0.0635 |
| 批量 30 章 | 0 | 0 | 30 | 42462519 | 915079 | 96863 | 97.9% | 1.9581 | 0.0653 |
| 批量 40 章（≈1M×0.7 压缩阈值边缘） | 0 | 0 | 40 | 66852826 | 1145236 | 121846 | 98.3% | 2.7260 | 0.0681 |
| 批量 50 章（超阈值，真机需压缩） | 0 | 0 | 50 | 96399087 | 1381455 | 151912 | 98.6% | 3.6133 | 0.0723 |
| 批量 60 章（超阈值，真机需压缩） | 0 | 0 | 60 | 129671729 | 1606166 | 172077 | 98.8% | 4.5438 | 0.0757 |

> 2026-08-16 修正说明：8/9 后阶段必读技能由 set_phase 系统注入（auto-inject），
> 但模拟器 plays 仍保留 auto_skill_injection 工具调用（read_required 改名后过滤条件
> 未同步）——技能全文被重复计数（update 类 45%）。修复 filterReadRequired 过滤条件
> + 批量路径补过滤 + missCatOf 按工具名分类（正文不再混入大纲）。修正后全场景 miss
> 降 8-23%，成本数字更贴近真实。
