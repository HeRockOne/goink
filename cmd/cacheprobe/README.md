...
2026-08-16 实测（DeepSeek 价 0.02/1/2，真实 DB + 门禁配置驱动，技能注入去重 + 查询 size + 首轮被动缓存 + 大纲/子代理校准后，reasoning low 档）：
...
| 批量 5 章 | 0 | 0 | 5 | 3693272 | 145485 | 27920 | 96.2% | 0.2752 | 0.0550 |
| 批量 5 章 + 短对话 2 | 0 | 2 | 5 | 5057775 | 210811 | 30195 | 96.0% | 0.3724 | 0.0745 |
| 混合 3+2+3 | 3 | 2 | 3 | 21276109 | 635151 | 62826 | 97.1% | 1.1863 | 0.1977 |
| 混合 5+5+5 | 5 | 5 | 5 | 50105298 | 1029254 | 97520 | 98.0% | 2.2264 | 0.2226 |
| 批量 10 章 | 0 | 0 | 10 | 6657208 | 175764 | 46303 | 97.4% | 0.4015 | 0.0402 |
| 批量 20 章 | 0 | 0 | 20 | 14134201 | 233716 | 80653 | 98.4% | 0.6777 | 0.0339 |
| 批量 30 章 | 0 | 0 | 30 | 24375096 | 299785 | 122635 | 98.8% | 1.0326 | 0.0344 |
| 批量 40 章（≈1M×0.7 压缩阈值边缘） | 0 | 0 | 40 | 37250815 | 359199 | 156063 | 99.0% | 1.4163 | 0.0354 |
| 批量 50 章（超阈值，真机需压缩） | 0 | 0 | 50 | 52708563 | 428228 | 199682 | 99.2% | 1.8818 | 0.0376 |
| 批量 60 章（超阈值，真机需压缩） | 0 | 0 | 60 | 71165473 | 491164 | 237461 | 99.3% | 2.3894 | 0.0398 |
...
> high 档 miss 171.2K vs 真机 167.0K（差 2.5%）、输出 51.6K vs 60.7K（差 15%，剩余 = 真机
> 审稿修复/人工介入的拖沓输出）；hit 仍差 2.4 倍 = 真机带 4 章旧历史 + 1M 窗口的结构性差异，
> 模拟器场景从空会话起步，非失真。命中率差 2.4pp = mimo 每轮新增固定内容被动缓存未建模。
