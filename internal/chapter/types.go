...
type Chapter struct {
	...
	NovelID       int64     `gorm:"column:novel_id;not null;uniqueIndex:uk_novel_chapter;index;constraint:OnDelete:CASCADE" json:"novel_id"`
...
type ChapterArc struct {
	...
	ChapterID  int64 `gorm:"column:chapter_id;not null;uniqueIndex:uk_chapter_arc;constraint:OnDelete:CASCADE" json:"chapter_id"`
	StoryArcID int64 `gorm:"column:story_arc_id;not null;uniqueIndex:uk_chapter_arc;constraint:OnDelete:CASCADE" json:"story_arc_id"`
}
