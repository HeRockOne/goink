...
const toolGroups: { label: string; tools: ToolEntry[] }[] = [
  {
    ...
    tools: [
      ...
      { name: 'get_item_occurrences', desc: 'help.toolRef_get_item_occurrences' },
      { name: 'create_item_occurrence', desc: 'help.toolRef_create_item_occurrence' },
      { name: 'update_phase_gate_config', desc: 'help.toolRef_update_phase_gate_config' },
      { name: 'get_phase_gate_config', desc: 'help.toolRef_get_phase_gate_config' },
      { name: 'get_writing_context', desc: 'help.toolRef_get_writing_context' },
      { name: 'update_chapter_meta', desc: 'help.toolRef_update_chapter_meta' },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'get_lore', desc: 'help.toolRef_get_lore' },
      { name: 'create_lore', desc: 'help.toolRef_create_lore' },
      { name: 'update_lore', desc: 'help.toolRef_update_lore' },
      { name: 'search_lore', desc: 'help.toolRef_search_lore' },
      { name: 'get_items', desc: 'help.toolRef_get_items' },
      { name: 'create_item', desc: 'help.toolRef_create_item' },
      { name: 'update_item', desc: 'help.toolRef_update_item' },
      { name: 'get_scenes', desc: 'help.toolRef_get_scenes' },
      { name: 'create_scene', desc: 'help.toolRef_create_scene' },
      { name: 'get_stats', desc: 'help.toolRef_get_stats' },
      { name: 'get_writing_snapshot', desc: 'help.toolRef_get_writing_snapshot' },
      { name: 'set_phase', desc: 'help.toolRef_set_phase' },
    ],
  },
]
