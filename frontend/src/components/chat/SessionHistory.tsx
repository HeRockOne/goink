...
export default function SessionHistory({ open, novelId, onClose, onSelectSession }: Props) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none">
      ...
      <div className={`absolute right-3 left-3 z-40 flex flex-col bg-sidebar border rounded-xl shadow-lg pointer-events-auto transition-all duration-200 ease-out overflow-hidden ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2'}`}
