...
export namespace config {
	...
	export class AppSettings {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.phase_gate_enabled = source["phase_gate_enabled"];
	        this.webdav_port = source["webdav_port"];
	        this.webdav_user = source["webdav_user"];
	        this.webdav_pass = source["webdav_pass"];
	        this.min_chapter_words = source["min_chapter_words"];
	        this.max_chapter_words = source["max_chapter_words"];
