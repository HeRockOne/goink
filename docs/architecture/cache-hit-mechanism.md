...
```
请求1: [固定前缀][novelstate][user: 写一章][tool: read core-writing-kernel]...
请求2: [固定前缀][novelstate][user: 写一章][tool: read core-writing-kernel][assistant: ...][tool: edit]...
         ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
...
```
请求N:   [固定前缀][历史][tool: read core-writing-kernel #1]...     → #1 写入缓存
